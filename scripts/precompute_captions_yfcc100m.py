...
from transformers import CLIPTextModel, CLIPTokenizer, Blip2Processor, Blip2ForConditionalGeneration
...
def main(args: Namespace) -> None:
    ...
    dataloader = build_streaming_laion_dataloader(
        ...
        local=[f"/tmp/mds-cache/mds-yfcc100m-blip2-12/{args.bucket}/{suffix}/" for suffix in ["256-512", "512-768"]],
